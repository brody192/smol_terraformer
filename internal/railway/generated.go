...
type CustomDomainCreateCustomDomainCreateCustomDomain struct {
	...
	Status        *CustomDomainCreateCustomDomainCreateCustomDomainStatus `json:"status,omitempty"`
}
...
type CustomDomainCreateCustomDomainCreateCustomDomainStatus struct {
	DnsRecords        []*CustomDomainCreateCustomDomainCreateCustomDomainStatusDnsRecordsDNSRecords              `json:"dnsRecords,omitempty"`
	CdnProvider       CDNProvider                                                                                `json:"cdnProvider,omitempty"`
	Certificates      []*CustomDomainCreateCustomDomainCreateCustomDomainStatusCertificatesCertificatePublicData `json:"certificates,omitempty"`
...
type CustomDomainCreateResponse struct {
	...
	CustomDomainCreate *CustomDomainCreateCustomDomainCreateCustomDomain `json:"customDomainCreate,omitempty"`
}
...
type ServiceConnectResponse struct {
	...
	ServiceConnect *ServiceConnectServiceConnectService `json:"serviceConnect,omitempty"`
}
...
type ServiceCreateResponse struct {
	...
	ServiceCreate *ServiceCreateServiceCreateService `json:"serviceCreate,omitempty"`
}
...
type ServiceInstanceUpdateInput struct {
	...
	NixpacksPlan            map[string]string   `json:"nixpacksPlan,omitempty"`
...
type ServiceInstanceUpdateResponse struct {
	...
	ServiceInstanceUpdate bool `json:"serviceInstanceUpdate,omitempty"`
}
...
type VariableCollectionUpsertResponse struct {
	...
	VariableCollectionUpsert bool `json:"variableCollectionUpsert,omitempty"`
}
...
func CustomDomainCreate(
...
) (*CustomDomainCreateResponse, error) {
	...
	var data_ CustomDomainCreateResponse
...
func ServiceConnect(
	...
	var data_ ServiceConnectResponse
	resp_ := &graphql.Response{Data: &data_}
...
func ServiceCreate(
	...
	var data_ ServiceCreateResponse
	resp_ := &graphql.Response{Data: &data_}
...
func ServiceInstanceUpdate(
...
) (*ServiceInstanceUpdateResponse, error) {
	req_ := &graphql.Request{
	...
	var data_ ServiceInstanceUpdateResponse
	resp_ := &graphql.Response{Data: &data_}
...
func VariableCollectionUpsert(
...
) (*VariableCollectionUpsertResponse, error) {
	req_ := &graphql.Request{
	...
	var data_ VariableCollectionUpsertResponse
	resp_ := &graphql.Response{Data: &data_}
